  ...
  return (
    <div className='flex justify-between items-center px-4 sm:px-12 lg:px-24
     ...
     dark:bg-gray-900/70'>
      ...
      <div className={`text-gray-700 dark:text-white sm:text-sm ${!openSidebar ?
       ...
       top-0 bottom-0 right-0 max-sm:min-h-screen max-sm:h-full max-sm:flex-col
        ...
        <img src={assets.close_icon} alt="" className='w-5 absolute right-4 top-4 sm:hidden' onClick={()=>setOpenSidebar(false)}/>

        <a onClick={()=>setOpenSidebar(false)} href="#home" className='sm:hover:border-b'>Home</a>
      ...
      <div className='flex items-center gap-2 sm:gap-4'>
        ...
        alt="" onClick={()=>setOpenSidebar(true)} className='w-8 sm:hidden'/>
