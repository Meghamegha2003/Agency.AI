...
const Hero = () => {
  return (
    <div id='home' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 
    ...
    dark:text-white'>
      ...
      <h1 className='text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium 
        xl:leading-[95px] max-w-5xl '>Trusting imagination into <span
      ...
      max-w-4/5 sm:max-w-lg pb-3'>Create a meaningful connections and turning big ideas into interactive digital experiences.</p>
