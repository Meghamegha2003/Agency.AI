...
const Services = () => {
    ...
    return (
        <div id='services' className='relative flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30
         text-gray-700 dark:text-white'>

            <img className='absolute -top-110 -left-70 -z-1 dark:hidden' src={assets.bgImage2} alt="" />

            <Title title='How can we help?' disc='From startegy to execute,we craft digital solutions that 
